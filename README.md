...
## 🕒 Emploi Public Scraper (Daily)

We run a GitHub Action daily to scrape the "Dernière chance pour postuler" offers
and store them in Firestore. Configure these repository secrets:
